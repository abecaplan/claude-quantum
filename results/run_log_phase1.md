...
**Job ID:** `d8ft3vbo3njc73f0qm00` · **QPU time:** ~113 s (~2 min of the 10-min/28-day budget)
...
## Verdict
- **Headline:** |S|_peak = **3.003 ± 0.029**, a **34.79σ** violation of the classical bound (S ≤ 2).
  Peak occurs on witness **S2 at θ = 1.286π**.
- **Note (scientific honesty):** several points exceed the Tsirelson bound 2.828 (marked ⚠ below).
  This is the expected over-correction from readout-error mitigation, **not** super-quantum behavior.
  The raw (resilience_level=0) value would sit at/below 2.828. Examined directly in Phase 3.

## Full θ-sweep (both witnesses, ± per-point std)
